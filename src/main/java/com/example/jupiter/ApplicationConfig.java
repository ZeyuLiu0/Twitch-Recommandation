...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        // make sure you add your own package name if your class is not under com.example.jupiter.entity.db
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "database-1.ccmjsnwdmscd.us-east-1.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "19941109";
